...
impl<'de, R: Deserialize<'de>> Deserialize<'de> for Response<R> {
    fn deserialize<D: Deserializer<'de>>(der: D) -> core::result::Result<Self, D::Error> {
        ...
        #[derive(Debug, Deserialize)]
        #[cfg_attr(feature = "defmt-03", derive(defmt::Format))]
        struct RespErr(isize, tstring!(32), Option<tstring!(32)>);
...
pub(crate) fn parse_configure(resp: &[u8]) -> Result<Extensions> {
    ...
    pub struct ConfigureRespRaw {
        ...
        pub version_rolling_mask: Option<tstring!(8)>,
        ...
        pub info_connection_url: Option<tstring!(32)>,

        #[serde(skip_serializing_if = "Option::is_none")]
        #[serde(rename = "info.hw-version")]
        pub info_hw_version: Option<tstring!(32)>,

        #[serde(skip_serializing_if = "Option::is_none")]
        #[serde(rename = "info.sw-version")]
        pub info_sw_version: Option<tstring!(32)>,

        #[serde(skip_serializing_if = "Option::is_none")]
        #[serde(rename = "info.hw-id")]
        pub info_hw_id: Option<tstring!(32)>,
    }
...
#[cfg(feature = "alloc")]
pub type Subscription = Vec<String>;
#[cfg(not(feature = "alloc"))]
pub type Subscription = Vec<tstring!(32), 2>;
...
pub(crate) fn parse_connect(resp: &[u8]) -> Result<ConnectResp> {
    ...
    struct ConnectRespRaw(
        ...
        #[cfg(feature = "alloc")] Vec<Vec<String>>,
        #[cfg(not(feature = "alloc"))] Vec<Vec<String<32>, 2>, 2>,
    ...
    impl TryFrom<ConnectRespRaw> for ConnectResp {
        ...
        fn try_from(raw: ConnectRespRaw) -> Result<Self> {
            Ok(Self {
                ...
                extranonce1: {
                    #[cfg(feature = "alloc")]
                    // v.resize(raw.1.len() / 2, 0);
                    let mut v = vec![0; raw.1.len() / 2];
                    #[cfg(not(feature = "alloc"))]
                    let mut v = Vec::new();
                    #[cfg(not(feature = "alloc"))]
...
mod tests {
    ...
    fn test_parse_connect() {
        ...
        let subs = vec![
            vec![
                String::from("mining.set_difficulty"),
                String::from("b4b6693b72a50c7116db18d6497cac52"),
            ],
            vec![
                String::from("mining.notify"),
                String::from("ae6812eb4cd7735a302a8a9dd95cf71f"),
            ],
        ];
        #[cfg(not(feature = "alloc"))]
        let subs = {
        ...
        #[cfg(feature = "alloc")]
        let extranonce1 = vec![0x08, 0x00, 0x00, 0x02];
        #[cfg(not(feature = "alloc"))]
        let extranonce1 = {
        ...
        #[cfg(feature = "alloc")]
        let subs = vec![
            vec![String::from("mining.set_difficulty"), String::from("1")],
            vec![String::from("mining.notify"), String::from("1")],
        ];
        #[cfg(not(feature = "alloc"))]
        let subs = {
            let mut subs = Vec::new();
